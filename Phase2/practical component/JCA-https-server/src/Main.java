...
public class Main {
    ...
    public static void main(String[] args) throws CertificateException, KeyStoreException, IOException, NoSuchAlgorithmException, UnrecoverableKeyException, KeyManagementException {
        ...
        keyStore.load(ClassLoader.getSystemResourceAsStream(SECURE_SERVER_PFX), "".toCharArray());
        keyStore.setCertificateEntry("secureServerCertificate", secureServerCertificate);
        ...
        SSLSocket sslSocket = (SSLSocket) sslSocketFactory.createSocket("www.secure-server.edu", 4433);
